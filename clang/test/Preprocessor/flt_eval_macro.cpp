...
// x87 only evaluates in the extended format once -fexcess-precision=fast lets
// that precision escape; otherwise every result is rounded to its own type.
// RUN: %clang_cc1 -E -dM -triple=x86_64-none-none -target-feature -sse \
...
// RUN:   | FileCheck -check-prefix=EXT %s -strict-whitespace
